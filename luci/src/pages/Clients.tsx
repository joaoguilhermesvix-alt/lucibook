...
import { Search, Plus, User, Phone, FileText, Loader2, Edit3, Image as ImageIcon, Camera } from "lucide-react";
            ...
            <div className="md:col-span-2 bg-white/40 p-4 rounded-2xl border border-white/50">
              ...
              <div className="grid grid-cols-2 gap-3">
                 ...
                 <div>
                    ...
                    <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full px-3 py-2 bg-white/50 rounded-xl focus:ring-2 focus:ring-pink-400 outline-none border border-white" />
                 </div>
              </div>
            </div>
